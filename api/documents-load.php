...
try {
    ...
    // Simuler un chargement réussi (à remplacer par la vraie logique une fois la base de données configurée)
    $result = [
        "success" => true,
        "documents" => [],
        "groups" => []
    ...
    // Gérer les erreurs
    error_log("Erreur dans documents-load.php: " . $e->getMessage());

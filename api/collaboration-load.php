...
try {
    ...
    error_log("Chargement des données de collaboration");
    ...
    $responseData = [
        'success' => true,
        'message' => 'Données de collaboration chargées avec succès',
        'timestamp' => date('c'),
        'documents' => []  // Un tableau vide pour les tests
    ];
    
    http_response_code(200);
    echo json_encode($responseData);
    error_log("Réponse de collaboration-load.php : " . json_encode($responseData));

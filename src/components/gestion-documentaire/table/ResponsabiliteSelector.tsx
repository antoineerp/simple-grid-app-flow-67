...
const ResponsabiliteSelector = ({ 
  selectedInitiales, 
  onChange, 
  type,
  disabled = false
}: ResponsabiliteSelectorProps) => {
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button className={`flex items-center justify-center p-1 ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100'} rounded`} disabled={disabled}>
...
export default ResponsabiliteSelector;
